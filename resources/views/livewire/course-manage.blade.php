<div class="space-y-8">
    ...
    <div class="flex justify-between gap-4 items-center">
        ...
        <select id="sort_category_kelola" name="sort_category_kelola" wire:model="categoryKelolaDropdownSort"
            ...
            @empty($skills)
                <option "selected">Tidak Ada Skil</option>
            @else
                        ...
                        <tr class="odd:bg-white even:bg-gray-100">
                            <td class="whitespace-nowrap px-3 py-4 w-full">
                                @if ($editedCourseTutorIndex !== $index)
                                    {{ $tutorSkills[$index] }}
                                @else
                                    <x-input wire:model.defer="coursesTutors.{{ $index }}.skill_id">
                                        <x-slot:type>text</x-slot:type>
                                        <x-slot:name>skill_id</x-slot:name>
                                        <x-slot:id>skill_id</x-slot:id>
