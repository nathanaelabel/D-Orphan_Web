            ...
            <div class="grid gap-4 p-4 lg:p-8">
                ...
                <div class="grid">
                    <div class="flex gap-2 items-center">
                        ...
                        <p class="text-lg leading-8 text-gray-500">Olympic Council of Asia</p>
                    </div>
                    <div class="flex gap-2 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 text-gray-500">
                ...
                <div class="text-gray-500">
                    <p>Pesta Olahraga Asia adalah ajang multi-olahraga yang diselenggarakan setiap empat tahun sekali,
                        dengan
                ...
                @if (Auth::user()->user_type == 'Tutor')
                    <hr class="border-2">
                    <form method="POST" action="{{ route('detail-lomba') }}" class="space-y-6">
                        @csrf
