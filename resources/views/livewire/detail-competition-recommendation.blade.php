            ...
            <div class="grid gap-4 p-4 lg:p-8">
                ...
                <div class="grid">
                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        <p class="text-lg leading-8 text-gray-700">
                            {{ date_format(date_create($competitionRecommendation->competition->registration_start_hour), 'H:i') . ' WIB' }}
                        </p>
                    </div>
                    <div class="flex gap-2 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <p class="text-gray-500">{{ $competitionRecommendation->competition->description }}</p>
