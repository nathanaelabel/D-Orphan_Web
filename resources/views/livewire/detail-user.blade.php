                        ...
                        @if (Auth::user()->user_type == 'Tutor')
                            <div class="flex gap-2 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <title>Nama {{ Auth::user()->user_type }}</title>
                                </svg>
                                <p class="text-xl leading-6 text-gray-500">{{ $user->user->name }}</p>
                            </div>
                        @endif
                    @else
                        <div class="flex gap-2 items-center">
                    ...
                    <div class="flex gap-2 items-center">
                        @if (auth()->user())
                            @if (Auth::user()->user_type == 'Tutor')
                                ...
                                <p class="text-lg leading-8 text-gray-500">{{ $user->member_count }}
                                    anak Panti
                                </p>
                            @endif
                        @else
                    ...
                    @auth
                        @if (Auth::user()->user_type == 'Pengurus Panti')
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <p class="text-lg leading-8 text-gray-500">{{ count($user->courses) }} kursus tersedia
                                </p>
                            </div>
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <p class="text-xl leading-6 text-gray-500">
                                    {{ date_format(date_create($user->user->created_at), 'd/m/Y') }}</p>
                            </div>
                    </div>
                    @endif
                @endauth
