        ...
        <div class="flex-1 p-4 space-y-4 flex flex-col">
            ...
            <div>
                <div class="flex gap-2 items-center">
                    ...
                    <p class="text-lg leading-8 text-gray-700">{{ $tarif }}</p>
                </div>
                <div class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 text-gray-700">
                    ...
                    <p class="text-lg leading-8 text-gray-700">{{ $lokasi }}</p>
                </div>
                <div class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 text-gray-700">
                    ...
                    <p class="text-lg leading-8 text-gray-700">{{ $sesi }}</p>
                </div>
                <div class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 text-gray-700">
                    ...
                    <p class="text-lg leading-8 text-gray-700">Maksimum {{ $anak }}</p>
                </div>
                <div class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 text-gray-700">
                ...
                @if ($value == 1)
                    <div class="mt-2">
                        <a href="{{ route('detail-reservation',$course_id)}}"> <button type="button"
                                class="w-full {{$bclass}} inline-flex justify-center items-center space-x-2 rounded focus:outline-none px-3 py-2 leading-6 bg-blue-500 hover:bg-blue-600 focus:ring focus:ring-blue-500 focus:ring-opacity-50 active:bg-blue-500 active:border-blue-500">
