        ...
        <div class="flex-1 p-4 space-y-2 flex flex-col">
            ...
            <div>
                <div class="flex gap-2 items-center">
                    ...
                    <p class="text-lg leading-8 text-gray-500">{{ $tanggal_registrasi_dimulai }}</p>
                </div>
                <div class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 text-gray-500">
                    ...
                    <p class="text-lg leading-8 text-gray-500">{{ $jam_registrasi_dimulai }}</p>
                </div>
                <div class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 text-gray-500">
                    ...
                    <p class="text-lg leading-8 text-gray-500">{{ $jenjang }}</p>
                </div>
            </div>
            <div class="mt-2">
                <button
